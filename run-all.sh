...
for i in {1..$runs}; do
  for nthreads in "${threads[@]}"; do
    ...
    python movielens_grizzly.py -t $nthreads -f $SA_HOME/python/benchmarks/datasets/movielens/_data/ml-1m/ >> results/movielens/weld.stdout 2>> results/movielens/weld.stderr 
